...
import AddTeam from "views/settings/manage-users/teams/AddTeam";
import TeamCard from "views/settings/manage-users/teams/TeamCard";
...
function Users() {
  ...
  return (
    <Box p={3}>
      ...
      <Grid container spacing={3} sx={{ maxWidth: 1400, mt: 1 }}>
