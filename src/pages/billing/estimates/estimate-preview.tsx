          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={6}>
              ...
              <Box p={2}>
                ...
                <Typography variant="body1">
                  2/91/20, BP Raju Marg, Laxmi Cyber City, Whitefields,
            ...
            >
              <Box sx={{ width: "50%" }}>
                <Box
                  sx={{ color: "#0D46A0", fontSize: "28px", fontWeight: 600 }}
                >
                  #INV7362773
                </Box>
            ...
            <Grid item xs={6}>
              <SectionHeading title={"Billed To"} />
              <Box p={2}>
                <Box>
                  <img src={logo} alt="" />
                </Box>
              ...
              <TableContainer>
                <Table>
                  ...
                  >
                    ...
                    >
                      <TableCell>Particulars (Task / Service name)</TableCell>
              ...
              <TableContainer>
                <Table>
                  ...
                  >
                    ...
                    >
                      <TableCell>Services as a Pure Agent</TableCell>
                      <TableCell>Amount</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
