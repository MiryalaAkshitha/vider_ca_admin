...
function ClientWiseTasksCompletedToBilledReport() {
  useTitle("ClientWiseTasksCompletedToBilled");
  ...
  const handleSubmit = () => {
    ...
    const updatedpayload = {
      query: 'ClientWiseTasksCompletedToBilledReport',
    ...
    <Box p={2}>
      <Breadcrumbs>
        ...
        <Typography color="text.primary">Invoices</Typography>
          <Typography color="text.primary">Client-Wise Task Completed To Billed Tasks</Typography>
      </Breadcrumbs>
...
export default ClientWiseTasksCompletedToBilledReport;