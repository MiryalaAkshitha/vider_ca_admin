...
function EstimateNumberSettings(props: IProps) {
  ...
  return (
    <DialogWrapper open={open} setOpen={setOpen} title="Estimate Number">
      <FormControlLabel
        onChange={() => {
          dispatch(
            handleFieldChange({
        ...
        label="Auto generate estimate number"
        control={
      ...
      <FormControlLabel
        ...
        label="Add estimate number manually for this Estimate"
      ...
      {state.estimateNumberType === "MANUAL" && (
        <Box display="flex" gap={1} mt={1}>
          ...
          <TextField
            ...
            fullWidth
            onChange={(e) => setNumber(`EST-${e.target.value}`)}
            sx={{ flex: 1 }}
            size="small"
            label="Number"
          />
...
export default EstimateNumberSettings;
