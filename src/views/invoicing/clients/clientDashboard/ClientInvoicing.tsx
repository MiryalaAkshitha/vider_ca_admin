...
const ClientInvoicing = () => {
  ...
  return (
    <Box p={3}>
      ...
      <Paper>
        <Box display="flex">
          <Box sx={{ width: '100%', maxWidth: 300, bgcolor: 'background.paper', borderRight: "1px solid #22222214" }}>
            <Typography p={2} variant='subtitle2'>Invoices</Typography>
            <Divider />
            <List component="nav" aria-label="main mailbox folders" sx={{ height: "65vh", overflow: "scroll" }}>
              {data.map((item, index) => {
                return (
                  <>
                    <ListItemButton
                    ...
                    >
                      <Box>
                        ...
                        <Box display="flex" justifyContent="space-between" width={250}>
                          <Typography variant='subtitle2'>{item.invoiceNum}</Typography>
                          <Typography variant='inherit'>{item.status}</Typography>
                        </Box>
                      </Box>
                    </ListItemButton>
                    <Divider />
