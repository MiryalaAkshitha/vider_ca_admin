...
import { bankAccountPattern, ifscPattern } from "utils/patterns";
...
const BankDetails = ({ data }) => {
  ...
  const handleSubmit = () => {
    let accountNumber = state.bankAccountNumber;
    let ifscCode = state.bankIfscCode;

    if (accountNumber && !bankAccountPattern.test(accountNumber)) {
      return snack.error("Invalid bank account number");
    }

    if (ifscCode && !ifscPattern.test(ifscCode)) {
      return snack.error("Invalid bank ifsc code");
    }
